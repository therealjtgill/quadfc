...
)
{
   ...
   //Serial.println(omega_magnitude*dt*180/M_PI, 9);
   //Serial.println(dt);
   ...
   //Serial.print(omega_magnitude, 9); Serial.print(" ");
   //Serial.print(omega_global_unit[0]*omega_magnitude*100); Serial.print(" ");
   //Serial.print(omega_global_unit[1]*omega_magnitude*100); Serial.print(" ");
   //Serial.print(omega_global_unit[2]*omega_magnitude*100); Serial.print(" ");
   //Serial.println("");
   ...
   //Serial.print(rod2[0]*100, 9); Serial.print(" ");
   //Serial.print(rod2[1]*100, 9); Serial.print(" ");
   //Serial.print(rod2[2], 9); Serial.print(" ");
   //Serial.println(" ");
